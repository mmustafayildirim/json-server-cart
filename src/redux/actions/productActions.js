...
export function getProductsSucces(products) {
    return { type: actionTypes.GET_PRODUCTS_SUCCES, payload: products }
}
export function createProductSuccess(products) {
    return { type: actionTypes.CREATE_PRODUCT_SUCCES, payload: products }
}
export function updateProductSuccess(products) {
    return { type: actionTypes.UPDATE_PRODUCT_SUCCES, payload: products }
}
